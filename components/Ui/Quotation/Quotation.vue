...
const businessSchema = z.object({
  ...
  businessRfc: z.string().min(12, { message: "El RFC debe tener 12 o 13 caracteres" })
  ...
  businessPhone: z.string().min(16,{message: "Teléfono de 10 números"})
...
const clientSchema = z.object({
  ...
  clientRfc: z.string().min(12, { message: "El RFC debe tener 12 o 13 caracteres" })
  .max(13, { message: "El RFC debe tener 12 o 13 caracteres" }),
  ...
  clientPhone: z.string().min(16,{message: "Teléfono de 10 números"})
  .max(16,{message: "Teléfono de 10 números"}).nullable().optional(),
});
