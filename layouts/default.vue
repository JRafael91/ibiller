<template>
	<div>
		<header class="z-20 bg-background/90 backdrop-blur">
			<UiContainer class="flex h-16 items-center justify-between lg:h-20">
													...
													<div class="mt-5">
														<ul class="flex w-full flex-col gap-5">
															<li v-for="b in 3" :key="b">
																...
																>
																	<div
																		class="h-[200px] w-full overflow-hidden rounded-lg shadow-sm"
																	>
																		<!-- eslint-disable-next-line vue/html-self-closing -->
																		<img
				...
				<div class="hidden items-center gap-3 lg:flex">
					<UiButton to="/acceso" variant="ghost" size="sm">Ingresar</UiButton>
					<UiButton to="/registro" size="sm">Registrarse</UiButton>
				</div>
			</UiContainer>
		</header>
